...
public class BaseLocalDateTimePageReq extends BasePageReq {
  @ApiModelProperty(value = "开始时间 yyyy-MM-dd HH:mm:ss", example = "yyyy-MM-dd HH:mm:ss")
  @DateTimeFormat
  private LocalDateTime startTime;

  @ApiModelProperty(value = "结束时间 yyyy-MM-dd HH:mm:ss", example = "yyyy-MM-dd HH:mm:ss")
  @DateTimeFormat
